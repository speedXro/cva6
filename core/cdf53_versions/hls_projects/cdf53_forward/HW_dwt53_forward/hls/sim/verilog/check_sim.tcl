...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.HW_dwt53_forward.autotvin_op1.dat"
         "c.HW_dwt53_forward.autotvin_op2.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.HW_dwt53_forward.autotvout_p_low_03.dat"
         "rtl.HW_dwt53_forward.autotvout_p_low_47.dat"
         "rtl.HW_dwt53_forward.autotvout_p_high_03.dat"
         "rtl.HW_dwt53_forward.autotvout_p_high_47.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
