...
if {[file isfile HW_dwt53_forward.autotvin.dat]} {
	file delete -force HW_dwt53_forward.autotvin.dat
}

if {[file isfile HW_dwt53_forward.autotvout.dat]} {
	file delete -force HW_dwt53_forward.autotvout.dat
}
