...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "HW_dwt53_forward.autotvin.dat"
	set constFileTvOut       "HW_dwt53_forward.autotvout.dat"
	set constFileHdlTvIn     "HW_dwt53_forward.autohdltvin.dat"
	set constFileHdlTvOut    "HW_dwt53_forward.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
