...
__attribute__((sdx_kernel("HW_dwt53_inverse", 0))) void HW_dwt53_inverse(uint64_t low_03, uint64_t low_47, uint64_t high_03, uint64_t high_47, uint64_t* p_out_0, uint64_t* p_out_1);
...
{
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=HW_dwt53_inverse
# 239 "../c_sources/dwt_idwt_cdf_5_3.c"
