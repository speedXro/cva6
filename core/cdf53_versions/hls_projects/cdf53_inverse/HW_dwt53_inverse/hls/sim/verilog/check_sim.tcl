...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.HW_dwt53_inverse.autotvin_low_03.dat"
         "c.HW_dwt53_inverse.autotvin_low_47.dat"
         "c.HW_dwt53_inverse.autotvin_high_03.dat"
         "c.HW_dwt53_inverse.autotvin_high_47.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.HW_dwt53_inverse.autotvout_p_out_0.dat"
         "rtl.HW_dwt53_inverse.autotvout_p_out_1.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
