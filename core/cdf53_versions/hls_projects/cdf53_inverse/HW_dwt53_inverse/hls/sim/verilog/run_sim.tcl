...
if {[file isfile HW_dwt53_inverse.autotvin.dat]} {
	file delete -force HW_dwt53_inverse.autotvin.dat
}

if {[file isfile HW_dwt53_inverse.autotvout.dat]} {
	file delete -force HW_dwt53_inverse.autotvout.dat
}
