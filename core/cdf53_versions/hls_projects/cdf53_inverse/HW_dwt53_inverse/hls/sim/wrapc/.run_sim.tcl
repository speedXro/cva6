...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "HW_dwt53_inverse.autotvin.dat"
	set constFileTvOut       "HW_dwt53_inverse.autotvout.dat"
	set constFileHdlTvIn     "HW_dwt53_inverse.autohdltvin.dat"
	set constFileHdlTvOut    "HW_dwt53_inverse.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
