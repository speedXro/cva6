...
#(
    ...
    output logic        ada_issued*/
);
    //assign ada_issued = instr_commit;

    localparam RISCADA_OPCODE = 7'b1111011;
    ...
    ADA_CVXIF_Adapter #(
        ...
        .X_NUM_RS(X_NUM_RS),
        .RISCADA_OPCODE(RISCADA_OPCODE)
    ) ADA_CVXIF_Adapter_inst(
        //Clock Interface
        .clk(clk_i),
    ...
    ADA_Extension ADA_Extension_inst(
        .clk(clk_i),
        .reset(reset_p),
