...
#(
    ...
    parameter DIWATO_OPCODE = 7'b1111011
)
(
    input  logic                             clk,
    ...
    always_comb begin
        ...
        if(issue_valid == 1'b1 && issue_instr_opcode == DIWATO_OPCODE) begin
            issue_accept        <= 1'b1;
    ...
    always_comb begin
        issue_ready     = 1'b0;
        if(issue_valid == 1'b1 && issue_instr_opcode == DIWATO_OPCODE && register_rs_valid_i == 2'b11) begin
            issue_ready         <= 1'b1;
        end
        else begin
            issue_ready         <= 1'b0; 
    ...
    assign input_all_valid = (issue_valid == 1'b1 && issue_instr_opcode == DIWATO_OPCODE && register_rs_valid_i == 2'b11);
